...
Sys.setenv(TZ="Etc/Universal") # add this to global R startup script or renviron
```
...
```{r}
cohort_def <- getCohortDefinition(cohortId = 50, baseUrl)
...
```{r, eval=F}
ROhdsiWebApi::invokeCohortGeneration(114, baseUrl, sourceKey = "synthea1k")
```
